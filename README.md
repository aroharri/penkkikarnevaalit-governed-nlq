...
<!-- KUVA: poista taman lohkon kommenttimerkit kun docs/kuvat/answer.png on paikallaan
![An answer with its citation](docs/kuvat/answer.png)
-->
...
<!-- KUVA: poista kommenttimerkit kun kuvat ovat docs/kuvat/-kansiossa
| Se vastaa | Se kysyy takaisin | Se kieltaytyy |
|---|---|---|
| ![](docs/kuvat/answer.png) | ![](docs/kuvat/clarify.png) | ![](docs/kuvat/refuse.png) |
-->
